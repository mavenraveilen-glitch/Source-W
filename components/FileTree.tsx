...
export default function FileTree({ files, activeId, onSelect }: Props) {
  return (
    <aside
      className="mb-2 flex max-h-36 w-full shrink-0 flex-col overflow-hidden rounded-lg border border-white/10 bg-gray-950/90"
      style={{
        boxShadow: '0 0 0 1px rgba(255,255,255,0.04), 0 0 16px rgba(255,255,255,0.04)',
      }}
    >
          ...
          return (
            <li key={f.id}>
              <button
                ...
                className={`flex w-full cursor-pointer items-center gap-2 px-3 py-1 text-left text-xs transition-colors duration-200 ${
                  active
